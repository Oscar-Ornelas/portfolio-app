      ...
      <a href="#about">
        ...
        <nav className={navSlide ? "nav navigation-open" : "nav navigation-close"}>
          ...
          <ul className="nav-list">
            ...
            <li className="nav-item" ><a className="nav-link" href="https://www.linkedin.com/in/oscar-ornelas-018a021a8/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin nav-social"></i></a></li>
          </ul>
        </nav>
      </div>
